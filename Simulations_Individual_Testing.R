...
###Helper function to calculate the probability that a pool with one positive tests positive
...
###Calculate the probability that a negative pool tests negative
...
###True biomarker distribuiton parameters
theta.0.true = c(2.5,0.5)
theta.1.true = c(80,2)
###True individual level biomarkers
...
###Set up Metropolis Hastings tuning
