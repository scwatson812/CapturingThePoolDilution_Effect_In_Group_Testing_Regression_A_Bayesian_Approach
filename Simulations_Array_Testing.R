...
range(W)
################################################################
#####  Specify Hyperparameters  for Biomarker Distribuitons#####
################################################################
N.cc = 100
...
###Specify hyperparmaters for error variance
a.sigma.w = 3
b.sigma.w = 3
...
###Set up tuning for metropolis hastings
...
#############################################
#####  Trace Plots for the  First MCMC  #####
#############################################
plot(beta.array[1,])
